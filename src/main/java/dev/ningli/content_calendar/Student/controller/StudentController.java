...
import dev.ningli.content_calendar.LoadCustomConfigService;
...
public class StudentController {
    ...
    private String mainModuleValue ;

    public StudentController(LoadCustomConfigService loadCustomConfigService) {
        this.loadCustomConfigService = loadCustomConfigService;
    }
    ...
    private void loadStudent(){
        ...
        System.out.println("mainModuleValue: " + mainModuleValue);
        System.out.println("loadCustomConfigService name: " + loadCustomConfigService.getName());
        System.out.println("loadCustomConfigService type: " + loadCustomConfigService.getType());
    }
